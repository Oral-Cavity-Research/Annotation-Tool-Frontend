...
const Contacts = () => {
    ...
    <>
        ...
        <h3>Contacts</h3>
            ...
            <li><p>For any inquiries regarding the dataset that are not addressed in the dataset description, please don't hesitate to reach out via email to <span className="blue">oasis@eng.pdn.ac.lk</span>.</p></li>
            <li><p>If you require further information about OASIS-Annotator or are interested in collaborating to enhance the dataset through the addition of new annotations, please feel free to get in touch with us at <span className="blue">oasis@eng.pdn.ac.lk</span>.</p></li>
            </ul>
            {/* <hr/>
            <h3>Credits</h3>
