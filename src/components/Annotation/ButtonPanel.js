...
const ButtonPanel = ({func, labelVisibility}) => {
    ...
    return (
        <div>       
            <Tooltip enterNextDelay={1000} title="Clear All" placement="bottom-end" arrow><IconButton size='small' onClick={func.clear_all}><CancelOutlined fontSize='small' sx={{color:"var(--dark-color)"}} /></IconButton></Tooltip>     
            ...
            <Tooltip enterNextDelay={1000} title="Clear Selected" placement="bottom-end" arrow><IconButton size='small' onClick={func.delete_selected}><Close  fontSize='small' sx={{color:"var(--dark-color)"}}/></IconButton></Tooltip>
            ...
            <Tooltip enterNextDelay={1000} title="Move Up" placement="bottom-end" arrow><IconButton size='small' onClick={()=>func.move_selected("ArrowUp", 10)}><ArrowUpward  fontSize='small' sx={{color:"var(--dark-color)"}}/></IconButton></Tooltip>
            <Tooltip enterNextDelay={1000} title="Move Down" placement="bottom-end" arrow><IconButton size='small' onClick={()=>func.move_selected("ArrowDown", 10)}><ArrowDownward  fontSize='small' sx={{color:"var(--dark-color)"}}/></IconButton></Tooltip>
            <Tooltip enterNextDelay={1000} title="Move Left" placement="bottom-end" arrow><IconButton size='small' onClick={()=>func.move_selected("ArrowLeft", 10)}><ArrowBack  fontSize='small' sx={{color:"var(--dark-color)"}}/></IconButton></Tooltip>
            <Tooltip enterNextDelay={1000} title="Clear Right" placement="bottom-end" arrow><IconButton size='small' onClick={()=>func.move_selected("ArrowRight", 10)}><ArrowForward  fontSize='small' sx={{color:"var(--dark-color)"}}/></IconButton></Tooltip>
